...
<div class="terms-container">
    ...
    <div class="max-w-4xl mx-auto px-4 py-16">
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-gray-800 mb-4">1. Godkännande av villkor</h2>
          <div class="prose text-gray-600">
            <p>Genom att gå in på och använda den här webbplatsen accepterar du och samtycker till att vara bunden av villkoren och bestämmelserna i detta
                avtal.</p>
          </div>
        </section>
